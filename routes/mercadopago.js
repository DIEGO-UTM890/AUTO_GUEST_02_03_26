    ...
    try {
        ...
        const response = await preference.create({
            body: {
                ...
                back_urls: {
                    success: '/pages/cliente/detalle_cita.html', // Update with your success URL
                    failure: '/pages/cliente/detalle_cita.html', // Update with your failure URL
                    pending: '/pages/cliente/detalle_cita.html', // Update with your pending URL
                },
